...
import { ArrowLeft, Store, Package, ShoppingBag, AlertTriangle, Shield, BarChart3 } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Monitor marketplace activity and analytics</p>
            </div>
          </div>
        </div>
      </div>
